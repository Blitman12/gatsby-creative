      ...
      <Layout>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <p className="text-white-50 mb-4">
                  {" "}
                  Sit back and relax while our team of professionals completes
                  the requested job in a timely and efficient manner
                </p>
                <a
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  <i className="fas fa-4x fa-th text-primary mb-4"></i>
                  <h3 className="h4 mb-2">Wall Building</h3>
                  <p className="text-muted mb-0">
                    Block, Fencing, Wood, etc...
                  </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  <i className="fas fa-4x fa-link text-primary mb-4"></i>
                  <h3 className="h4 mb-2">Wall Repair</h3>
                  <p className="text-muted mb-0">We can even fix Stucco</p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 text-center">
                <div className="mt-5">
                  <i className="fas fa-4x fa-car text-primary mb-4"></i>
                  <h3 className="h4 mb-2">RV Gates</h3>
                  <p className="text-muted mb-0">
                    RV Gate Repair and Installation
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="page-section" id="contact">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                <h2 className="mt-0">Lets get to work!</h2>
                <hr className="divider my-4" />
                <p className="text-muted mb-5">
                  Contact us here for more information and estimates
                </p>
              </div>
            </div>
            <div className="row">
